...
% CHANGED PARAMETERS
%\setlength{\topmargin}{-32.2mm} % = 0mm -1in + 23.2mm
\setlength{\topmargin}{-17.2mm} % = 0mm -1in + 23.2mm
\setlength{\textheight}{246.9mm} % = 297mm -29.5mm -31.6mm - 14mm (12 to accomodate footline with pagenumber)
%\setlength{\headheight}{34mm} % title height from text
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\titleformat{\chapter}[display]  % type (section,chapter,etc...) to vary,  shape (eg display-type)
    ...
    % CHANGED PARAMETERS
    \node[yshift=-5.5cm] at (current page.north west)
    % ORIGINAL PARAMETERS
    %\node[yshift=-8cm] at (current page.north west)
      {\begin{tikzpicture}[remember picture, overlay]
        \draw[fill=black] (0,0) rectangle(35.5mm,15mm);
        % CHANGED PARAMETERS
        \node[anchor=north east,yshift=-4.7cm,xshift=34mm,minimum height=30mm,inner sep=0mm] at (current page.north west)
        ...
        \node[anchor=north west,yshift=-4.7cm,xshift=37mm,text width=\textwidth,minimum height=30mm,inner sep=0mm] at (current page.north west)
