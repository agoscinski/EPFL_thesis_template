...
\setlength{\topmargin}{-22.2mm} % = 0mm -1in + 23.2mm
\setlength{\textheight}{251.9mm} % = 297mm -29.5mm -31.6mm - 14mm (12 to accomodate footline with pagenumber)
...
\titleformat{\chapter}[display]  % type (section,chapter,etc...) to vary,  shape (eg display-type)
    ...
    %\node[yshift=-8cm] at (current page.north west)
      {\begin{tikzpicture}[remember picture, overlay]
        ...
        % CHANGED PARAMETERS
        \node[anchor=north east,yshift=-4.2cm,xshift=34mm,minimum height=30mm,inner sep=0mm] at (current page.north west)
        ...
        \node[anchor=north west,yshift=-4.2cm,xshift=37mm,text width=\textwidth,minimum height=30mm,inner sep=0mm] at (current page.north west)
