...
\label{sub:hypers}
We begin by considering two practical realizations of atom-centred symmetrized features of order $\nu=2$ in Eq.~\ref{eq:soap} as implemented in \texttt{librascal}\cite{LIBRASCAL}, and the BPSF\cite{behl11jcp} as implemented in the n2p2 package\cite{singraber2019parallel}. 
...
%The invariant SOAP features are then computed as specified in Eq.~\ref{eq:soap},
%\begin{equation}
%\label{eq:SOAP}
