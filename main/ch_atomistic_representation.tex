...
A natural solution is therefore the usage of the same basis set across all environments in all structures~\cite{behl11jcp,bartok2013representing,drautz2019atomic}.
