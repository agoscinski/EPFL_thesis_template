...
\begin{align}
  ...
  \rho_{ji}(\mathbf{r}) &= \rho(\mathbf{r}-\mathbf{r}_{ji}),\quad \rho_{ji}:\mathbb{R}^3\rightarrow\mathbb{R}\quad\text{(neighbor density of atom $j$ centered at $i$)},\\
  \rho_i(\mathbf{r}) &= \sum_{j\in A_i} \rho_{ji}(\mathbf{r}),\quad \rho_i:\mathbb{R}^3\rightarrow\mathbb{R}\quad\text{(environmental density of atom $i$)},
\end{align}
\end{subequations}
...
\begin{equation}
  \rho_{ji}(\mathbf{r}) = \rho_{ji,r}(r)\rho_{ji,\perp \mathbf{r}}(\hat{\mathbf{r}}).
\end{equation}
