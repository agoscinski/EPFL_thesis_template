...
\begin{tabular}{ll}
  ...
  $\rho$ & atomic density \\ 
  $\rho_{ij}$ & neighbor density \\ 
  $\rho_i$ & environmental density \\ 
  $\overline{\rho^{\otimes \nu}}$ & symmetrized order $\nu$ correlations of the density \\
  $c_{nlm}$ & spherical expansion coefficient \\
  $c_{anlm}$ & spherical expansion coefficient considering species $a$ \\
  $c^i_{nlm}$ & spherical expansion coefficient of environmental density $i$ \\
  $c^{ij}_{nlm}$ & spherical expansion coefficient of neighbor density $\rho_{ij}$ \\
  $c^{ij}_{nl}$ & radial expansion coefficient of neighbor density $\rho_{ij}$ \\
\end{tabular}
