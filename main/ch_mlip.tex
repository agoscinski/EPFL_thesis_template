...
By incorperating metadata into the data type, these operations can be implemented more generically and thus be reused for multiple model implementations.
